...
public class TestJobs2dPatterns {
    ...
    private static void setupPresetTests(Application application) {
        ...
        application.addTest("Figure Joe 2", action -> FiguresJoe.figureScript2(DriverFeature.getDriverManager().getCurrentDriver()));
    }
    ...
    private static void setupDrivers(Application application) {
        ...
        Job2dDriver basicDottedDriver = new LineDrawerAdapter(LineFactory.getDottedLine());
        DriverFeature.addDriver("Dotted Line", basicDottedDriver);
